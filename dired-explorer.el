...
(if dired-explorer-mode-map ()
  ...
  (define-key dired-explorer-mode-map "[" 'dired-maybe-insert-subdir)
  (define-key dired-explorer-mode-map "]" 'dired-kill-subdir)
  (define-key dired-explorer-mode-map "\M-i" 'dired-maybe-insert-subdir)
  (define-key dired-explorer-mode-map "\M-k" 'dired-kill-subdir)
